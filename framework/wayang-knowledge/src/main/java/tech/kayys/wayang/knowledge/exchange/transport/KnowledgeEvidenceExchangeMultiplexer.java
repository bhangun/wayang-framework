...
/**
 * Defines the contract for knowledge evidence exchange multiplexer operations in the Wayang framework.
 */


public interface KnowledgeEvidenceExchangeMultiplexer {

    KnowledgeEvidenceExchangeStream openStream(
            String sessionId
    );
