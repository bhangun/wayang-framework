...
/**
 * Defines the contract for knowledge answer resolution policy operations in the Wayang framework.
 */


public interface KnowledgeAnswerResolutionPolicy {

    KnowledgeAnswerResolutionDecision decide(
