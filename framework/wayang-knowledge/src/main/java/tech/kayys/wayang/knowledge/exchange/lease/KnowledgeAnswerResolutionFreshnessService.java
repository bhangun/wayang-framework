...
/**
 * Defines the contract for knowledge answer resolution freshness service operations in the Wayang framework.
 */


public interface KnowledgeAnswerResolutionFreshnessService {
