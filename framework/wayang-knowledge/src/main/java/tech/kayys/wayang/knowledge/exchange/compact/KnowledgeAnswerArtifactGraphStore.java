...
public interface KnowledgeAnswerArtifactGraphStore {
    ...
    List<KnowledgeAnswerArtifactRelation> relationsFrom(
            String artifactId
    );

    List<KnowledgeAnswerArtifactRelation> relationsTo(
            String artifactId
    );

    List<KnowledgeAnswerArtifactRelation> relationsBetween(
