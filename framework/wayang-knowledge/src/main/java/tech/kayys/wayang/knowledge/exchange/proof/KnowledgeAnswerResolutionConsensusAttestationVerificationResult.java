...
public record KnowledgeAnswerResolutionConsensusAttestationVerificationResult(
        ...
        int totalAttestations,

        int validAttestations,

        int requiredAttestations,

        boolean quorumVerified,

        boolean resolutionAgreement,

        boolean dependencyAgreement,

        List<String> trustedRuntimeIds,
    ...
    public KnowledgeAnswerResolutionConsensusAttestationVerificationResult {
        ...
        trustedRuntimeIds =
                trustedRuntimeIds == null
                        ? List.of()
                        : List.copyOf(trustedRuntimeIds);
