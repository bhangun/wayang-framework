...
public record KnowledgeAnswerResolutionRevalidationRequest(
        ...
        KnowledgeAnswerResolutionRevalidationReason reason,
        Instant requestedAt,
    ...
    public KnowledgeAnswerResolutionRevalidationRequest {
        Objects.requireNonNull(consensusId, "consensusId");
        Objects.requireNonNull(keyFingerprint, "keyFingerprint");
        Objects.requireNonNull(requestingRuntimeId, "requestingRuntimeId");
