...
/**
 * Defines the contract for knowledge evidence federation routing scorer operations in the Wayang framework.
 */



public interface KnowledgeEvidenceFederationRoutingScorer {
